...
showFloorDetails();
	...
	/**
	 * Manual Code - Show Floor Details
	 */
	function showFloorDetails() {
		$("#spaces-list").addClass("spaces-list--hidden");
	}

	/**
	 * Manual Code - Hide Floor Details
	 */
	function hideFloorDetails() {
		$("#spaces-list").removeClass("spaces-list--hidden");
	}
